	...
	<div class="container" id="destaque-produtos-container">
		<div id="destaque-produtos" class="owl-carousel  owl-theme">
			...
			<div class="item" ng-repeat="produto in produtos">
				...
				<div class="col-sm-6 col-imagem float-left">
				...
				<div class="col-sm-6 col-descrição float-right">
					...
					<div class="box-valor">
						...
						<div class="text-parcelas text-arial-cinza">ou até {{produto.parcelas}}x de R$ {{produto.parcela}}</div>
