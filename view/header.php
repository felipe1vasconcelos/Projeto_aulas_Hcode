...
<head>
	...
	<script src="https://kit.fontawesome.com/4c257fd793.js" crossorigin="anonymous"></script>
...
<body>
	...
	<header>
		...
		<button id="btn-bars" type="button" class="d-sm-none"><i class="fas fa-bars"></i></button>

		<button id="btn-search" type="button" class="d-sm-none"><i class="fas fa-search"></i></button>
				<ul class="float-right"> <!--pull-right foi trocado no bootstrap 4 para float-right-->
